<?php
// source: /home/marek/public_html/IIS-projekt/nette/app/config/config.neon 
// source: /home/marek/public_html/IIS-projekt/nette/app/config/config.local.neon 

class Container_549d122ee1 extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/home/marek/public_html/IIS-projekt/nette/app',
			'wwwDir' => '/home/marek/public_html/IIS-projekt/nette/www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => '/home/marek/public_html/IIS-projekt/nette/app/../temp',
		));
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/home/marek/public_html/IIS-projekt/nette/app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/home/marek/public_html/IIS-projekt/nette/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/home/marek/public_html/IIS-projekt/nette/app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		return new Container_549d122ee1_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('/home/marek/public_html/IIS-projekt/nette/app/../temp/cache/latte');
...
final class Container_549d122ee1_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_549d122ee1 $container)
	{
