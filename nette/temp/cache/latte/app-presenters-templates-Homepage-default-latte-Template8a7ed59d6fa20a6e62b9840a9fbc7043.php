<?php
// source: /home/marek/public_html/IIS-projekt/nette/app/presenters/templates/Homepage/default.latte

class Template8a7ed59d6fa20a6e62b9840a9fbc7043 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('33e2203d44', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb15c4037443_content')) { function _lb15c4037443_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb1ec7642bdf_title')) { function _lb1ec7642bdf_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbf19f80cb9a_scripts')) { function _lbf19f80cb9a_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb790359b890_head')) { function _lb790359b890_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
	...
	.boxes > div { background: #f0f0f0; border: 1px solid #e6e6e6; border-radius: 5px; margin-right: 2em; }
