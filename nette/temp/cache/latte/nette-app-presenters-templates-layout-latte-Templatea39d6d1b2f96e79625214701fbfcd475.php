<?php
// source: /home/marek/public_html/IIS-projekt/nette/app/presenters/templates/@layout.latte

class Templatea39d6d1b2f96e79625214701fbfcd475 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('181847f8da', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbf79c8baa06_head')) { function _lbf79c8baa06_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb7303ab60ee_scripts')) { function _lb7303ab60ee_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
